...
def interact(win, score_data, sef, sem):
    ...
    #----------------------Fruit Mover and Contact Script-------#
        ...
        try:
            ...
            v1, v2, v3, v4 = fruit1.getAnchor().getX(), fruit1.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
            ...
            v1, v2, v3, v4 = fruit2.getAnchor().getX(), fruit2.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
            ...
            v1, v2, v3, v4 = fruit3.getAnchor().getX(), fruit3.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
            ...
            if fruit4.getAnchor().getY() < 555 and perm3 == True:
                ...
                perm4 = True
            v1, v2, v3, v4 = fruit4.getAnchor().getX(), fruit4.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
            ...
            v1, v2, v3, v4 = fruit5.getAnchor().getX(), fruit5.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
        ...
        # ---------------------------------------------------------------Coelho
            ...
            v1, v2, v3, v4 = fruit6.getAnchor().getX(), fruit6.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
            if (v1 > v3-30 and v1 < v3+30) and (v2 > v4-30 and v2 < v4+30) and perm4 == True:
        ...
        # ---------------------------------------------------------------Lesma
            ...
            v1, v2, v3, v4 = fruit7.getAnchor().getX(), fruit7.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
            if (v1 > v3-30 and v1 < v3+30) and (v2 > v4-30 and v2 < v4+30) and perm4 == True:
                print("=CONTACT -5SPEED")
                fruit7.undraw()
        ...
        # ---------------------------------------------------------------Limpa
            ...
            v1, v2, v3, v4 = fruit8.getAnchor().getX(), fruit8.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
            if (v1 > v3-30 and v1 < v3+30) and (v2 > v4-30 and v2 < v4+30) and perm4 == True:
        ...
        # ---------------------------------------------------------------Kiwi
            ...
            v1, v2, v3, v4 = fruit9.getAnchor().getX(), fruit9.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
            if (v1 > v3-30 and v1 < v3+30) and (v2 > v4-30 and v2 < v4+30) and perm4 == True:
        ...
        # ---------------------------------------------------------------Melancia
            ...
            v1, v2, v3, v4 = fruit10.getAnchor().getX(), fruit10.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
            if (v1 > v3-30 and v1 < v3+30) and (v2 > v4-30 and v2 < v4+30) and perm4 == True:
        ...
        # ---------------------------------------------------------------Mamão
            ...
            v1, v2, v3, v4 = fruit11.getAnchor().getX(), fruit11.getAnchor(
            ).getY(), objc1_pxy.getX(), objc1_pxy.getY()
            if (v1 > v3-30 and v1 < v3+30) and (v2 > v4-30 and v2 < v4+30) and perm4 == True:
        ...
        if key == ("p" or "P"):
            ...
            while key != "p":
                ...
                if key == "t":
                    ...
                    objpx, objpy, speedy, speedx, gravit_s, jump_border_line, up, score = game_shell.call_t(
